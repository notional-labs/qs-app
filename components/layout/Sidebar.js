            ...
            <Flex justify={"space-between"} direction={"column"}>
              <NavbarBrand className="text-black dark:text-white logo flex items-center font-semibold text-xl">
                {full ? (
                  ...
                  <ChakraImage
                    alt="cnweb logo"
                    src={"/logo/qs_logo.svg"}
                    boxSize={"100%"}
                  />
                )}
                <button
                  className={full ? `resize-btn` : `resize-btn minimal-btn`}
                  onClick={resize}
                  style={{ left: full ? ".9em" : "-.9em" }}
                >
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        ...
                        boxShadow:
                          currentPath.includes(button.path) &&
                          "7px 7px 22px #242424, -7px -7px 22px #383838",
                      }}
                    >
                      {currentPath.includes(button.path) ? (
                        <ChakraImage
                          src={button.currentPathImg}
                          boxSize={"80%"}
                        />
                      ) : (
                      ...
                      <p
                        style={{
                          ...
                          display: !full && "none",
                          color: currentPath.includes(button.path)
                            ? "rgba(14, 14, 14, 1)"
                            : "rgba(255, 255, 255, 1)",
                        }}
                      >
